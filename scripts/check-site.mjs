...
const networkGuide=await readFile(path.join(publicRoot,"guides-internet-linked-radio-networks.html"),"utf8"); if(!networkGuide.includes("International Radio Network")||!networkGuide.includes("ANZEL / ANZ3L")||!networkGuide.includes("ZMR Radio")||!networkGuide.includes("Network Radios")) problems.push("The internet-linked radio networks guide is incomplete.");
